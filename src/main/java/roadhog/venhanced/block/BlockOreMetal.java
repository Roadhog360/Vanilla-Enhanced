...
public class BlockOreMetal extends Block {
	...
	public BlockOreMetal(Material material) {
		super(material);
	...
	public void registerBlockIcons(IIconRegister iconRegister) {
		...
		for (int i = 0; i < metaBlocks.length; i++) {
			texture[i] = iconRegister.registerIcon(VanillaEnhanced.modid + ":" + "blockOre" + metaBlocks[i]);
		}
