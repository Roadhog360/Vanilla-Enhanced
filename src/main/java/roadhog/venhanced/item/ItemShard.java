...
public class ItemShard extends Item {
	...
	final static String[] metaItems = new String[] {"Coal", "Charcoal", "Anthracite", "Diamond", "Emerald", "Ruby", "Sapphire"};
    ...
    public void registerIcons(IIconRegister icon)
    {
        ...
        for (int i = 0; i < metaItems.length; ++i) {
            this.texture[i] = icon.registerIcon(VanillaEnhanced.modid + ":" + "itemShard" + metaItems[i]);
        }
    }
